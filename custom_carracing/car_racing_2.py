...
def preprocess_observation(observation):
    ...
    I = observation[0:80, 6:86]  # crop bottom bar and 8 pixels left/right for quadratic image
    I = 2*(0.2989 * I[:,:,0] + 0.5879 * I[:,:,1] + 0.1140 * I[:,:,2])-1 # Grey Image
...
class CarRacing2(gym.Env, EzPickle):
    ...
    def _set_config(self,
        ...
        if self.preprocessed:
            self.observation_space = spaces.Box(low=0, high=255, shape=(40, 40, 1), dtype=np.uint8)
        else:
