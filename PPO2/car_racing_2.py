...
class CarRacing2(gym.Env, EzPickle):
    ...
    def _set_config(self, grayscale=True, vae_input=False, skip_frames=1, num_stack=1, continuous=True):
    ...
    def step(self, action, is_start=False):
        ...
        return self.preprocess_observation(self.state, is_start), accum_reward, done, {}
