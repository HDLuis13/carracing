...
model = PPO2.load("./t_log/ppo2_sf3_ns4_steps2048_100000.pkl", env=env, verbose=2, tensorboard_log='./t_log/')
timesteps = 100000
for i in range(9):
    timesteps_total = timesteps*(i+1)+100000
    model.learn(total_timesteps=timesteps, tb_log_name='ppo2_sf3_ns4_steps2048_{}'.format(timesteps_total), reset_num_timesteps=False)
